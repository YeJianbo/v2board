    ...
    public function fetch(Request $request)
    {
        ...
        $data = [
            ...
            'telegram' => [
                ...
                'telegram_machine_quality_alert_enable' => (int)config('v2board.telegram_machine_quality_alert_enable', 0),
                'telegram_machine_quality_latency_threshold' => (float)config('v2board.telegram_machine_quality_latency_threshold', 300),
                'telegram_machine_quality_loss_threshold' => (float)config('v2board.telegram_machine_quality_loss_threshold', 30),
                'telegram_machine_quality_consecutive_count' => (int)config('v2board.telegram_machine_quality_consecutive_count', 3),
                'telegram_machine_quality_cooldown_seconds' => (int)config('v2board.telegram_machine_quality_cooldown_seconds', 1800),
