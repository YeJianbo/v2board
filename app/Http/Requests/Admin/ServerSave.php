...
class ServerSave extends FormRequest
{
    ...
    {
        return [
            'type' => 'required|in:shadowsocks,vmess,trojan,tuic,hysteria,vless,anytls,v2node',
            ...
            'tls_settings.certificate_fingerprint' => 'nullable|string',
            'tls_settings.certificate_public_key_sha256' => 'nullable|array',
            'tls_settings.certificate_public_key_sha256.*' => 'nullable|string',
    ...
    private function buildTlsObjectRules(bool $includeRoot = false): array
    {
        return array_merge(
            ...
            [
                ...
                'tls.certificate_fingerprint' => 'nullable|string',
                'tls.certificate_public_key_sha256' => 'nullable|array',
                'tls.certificate_public_key_sha256.*' => 'nullable|string',
