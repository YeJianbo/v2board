...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('v2_machine_metric_minute')) {
            return;
        }

        Schema::create('v2_machine_metric_minute', function (Blueprint $table) {
            ...
            $table->unique(['machine_id', 'recorded_at'], 'machine_metric_machine_minute_unique');
            $table->index('recorded_at', 'machine_metric_recorded_at_index');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('v2_machine_metric_minute');
    }
};
